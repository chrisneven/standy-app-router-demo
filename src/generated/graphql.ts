...
export type ScheduledOperationAffectedDocument = Article | Asset;
...
export type ArticlesQuery = { __typename?: 'Query', articles: Array<{ __typename?: 'Article', id: string, title: string, slug: string, content: string, image?: { __typename?: 'Asset', url: string } | null }> };
...
export type ArticleQuery = { __typename?: 'Query', article?: { __typename?: 'Article', id: string, title: string, slug: string, content: string, image?: { __typename?: 'Asset', url: string } | null } | null };
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    Articles(variables?: ArticlesQueryVariables, options?: C): Promise<ArticlesQuery> {
      return requester<ArticlesQuery, ArticlesQueryVariables>(ArticlesDocument, variables, options) as Promise<ArticlesQuery>;
    },
    Article(variables: ArticleQueryVariables, options?: C): Promise<ArticleQuery> {
      return requester<ArticleQuery, ArticleQueryVariables>(ArticleDocument, variables, options) as Promise<ArticleQuery>;
    }
  };
}
